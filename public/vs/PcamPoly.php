...
<html lang="en"><link rel="stylesheet" href="./RTMP Player - HLSPlayer_files/font-awesome.min.css"><head>
...
function funcAvisa5(){
 var mensaje = window.confirm("Seras redirecccionado a la pagina principal");
 if (mensaje) {
...
<script type="text/javascript">
//<![CDATA[
try{if (!window.CloudFlare) {var CloudFlare=[{verbose:0,p:0,byc:0,owlid:"cf",bag2:1,mirage2:0,oracle:0,paths:{cloudflare:"/cdn-cgi/nexp/dok3v=1613a3a185/"},atok:"3b7b37ccce276a649f3868e479650849",petok:"3f09defc6f866885e218165a6d77670c6e3a6479-1495664634-1800",zone:"hlsplayer.net",rocket:"0",apps:{"ga_key":{"ua":"UA-76038853-1","ga_bs":"2"}}}];!function(a,b){a=document.createElement("script"),b=document.getElementsByTagName("script")[0],a.async=!0,a.src="//ajax.cloudflare.com/cdn-cgi/nexp/dok3v=85b614c0f6/cloudflare.min.js",b.parentNode.insertBefore(a,b)}()}}catch(e){};
//]]>
</script>
<style>
.container2 {
...
.form-control, .btn, textarea, .open>.dropdown-menu {
	border-radius: 2px;
}
...
<link rel="apple-touch-icon" sizes="57x57" href="https://www.hlsplayer.net/apple-icon-57x57.png">
<link rel="apple-touch-icon" sizes="60x60" href="https://www.hlsplayer.net/apple-icon-60x60.png">
<link rel="apple-touch-icon" sizes="72x72" href="https://www.hlsplayer.net/apple-icon-72x72.png">
<link rel="apple-touch-icon" sizes="76x76" href="https://www.hlsplayer.net/apple-icon-76x76.png">
<link rel="apple-touch-icon" sizes="114x114" href="https://www.hlsplayer.net/apple-icon-114x114.png">
<link rel="apple-touch-icon" sizes="120x120" href="https://www.hlsplayer.net/apple-icon-120x120.png">
<link rel="apple-touch-icon" sizes="144x144" href="https://www.hlsplayer.net/apple-icon-144x144.png">
<link rel="apple-touch-icon" sizes="152x152" href="https://www.hlsplayer.net/apple-icon-152x152.png">
<link rel="apple-touch-icon" sizes="180x180" href="https://www.hlsplayer.net/apple-icon-180x180.png">
...
/* <![CDATA[ */
var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-76038853-1']);
...
<body>
	<script type="text/javascript">
	/*se la llama a los 120 segundos*/
	//setTimeout(funcAvisa5,120000);
	</script>
	<?php
	include("../connect.php");
	$querylonlat =mysqli_query($con,"select centrocomercial,longitud,latitud from vloxysecuritydb.cameras");
	class pointLocation {
		...
		#echo "point " . ($key+1) . " ($point): <b>" . $pointLocation->pointInPolygon($point, $polygon) . "</b><br>";
						...
						$cadena2=trim($cadena);
							...
							if($cadena2!='outside'){
								...
								$query="select cameraid,typecam,ipserver,dcamara from vloxysecuritydb.cameras where longitud='".$longitud."' and latitud='".$latitud."'";
								$result = $con->query($query);
								$row = $result->fetch_assoc();
								$ip=$row['ipserver'];
								$cam=strtolower($row['dcamara']);
								?>
								<!-- inicia div player-->
								...
								<div class="col-md-4">
									<div class="row" >
										<div id="capa" style="padding: 5px, 5px, 2px, 2px;">
											...
											<?php if($row['typecam']==1){ ?>
												<iframe width="250" height="300" style="width: 98%;visibility: visible;" src="../cam/?id=<?php echo $row['cameraid'];?>" id="iframe" frameborder="0" allowfullscreen="allowfullscreen"></iframe>
												<?php }else{ ?>		
												<object type="application/x-shockwave-flash" id="player" data="./RTMP Player - HLSPlayer_files/GrindPlayer.swf" width="250" height="300" style="width: 98%;visibility: visible;"><param name="allowFullScreen" value="true"><param name="allowScriptAccess" value="always"><param name="wmode" value="opaque"><param name="flashvars" value="autoPlay=true&amp;src=rtmp://<?php echo $ip; ?>:1935/<?php echo $cam; ?>&amp;streamType=live&amp;scaleMode=letterbox"></object>
												<?php } ?>
													<div id="player-tip" style="display: none;"></div>
											</div>	
										</div>
									</div>
								</div><!-- Div close player    -->
