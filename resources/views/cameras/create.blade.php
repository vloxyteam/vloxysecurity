...
@section('content')
                ...
                <input type="hidden" name="_token" value="{!! csrf_token() !!}" >                                  
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="email" class="form-control" id="centrocomercial" name="centrocomercial" placeholder="Centro comercial">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea class="form-control" id="dcamara" name="dcamara" placeholder="Descripcion de la camara"></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="ipserver" name="ipserver" placeholder="Ip de Camara">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" id="estado" name="estado"> Estado Activo/Inactivo</a>
                        </label>
                      </div>
                    </div>
                  </div>
